...
function setAlignment(align: 'left' | 'center' | 'right') {
  ...
  // container.style.textLAlign = align;
}
...
let userDate: UserDateType = {
  name: '이승아',

  height: '123',
  age: 29,
  isStudent: false,
  // hobby: ['exercise', 'reading'] // 필요한 형식은 이 인덱스 시그니처에서 가져옵니다. - 해당 인덱스 서명
}

userDate.email = 'devginats75';
// userDate.address = { city: 'Busan' };