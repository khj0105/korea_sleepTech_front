    ...
    var addEventListener_1 = function (users) {
        ...
        if (userList) {
            userList.addEventListener('click', function (e) {
                ...
                // - currentTarget: 발생한 이벤트가 등록된(이벤트 핸들러가 바인딩 된) 전체 DOM 요소(userList)
                var target = e.target; // const target = e.target => const target: EventTarget | null
